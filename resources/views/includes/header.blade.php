...
<head>
  ...
  <!-- Top Slider CSS -->
  <link href="{{asset('public/css/sequence-theme.modern-slide-in.css')}}" rel="stylesheet" media="all">
            ...
            <div class="aa-header-top-area">
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="{{url('public/img/flag/english.jpg')}}" alt="english flag">ENGLISH
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="{{url('public/img/flag/french.jpg')}}" alt="">FRENCH</a></li>
                      <li><a href="#"><img src="{{url('public/img/flag/english.jpg')}}" alt="">ENGLISH</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li class="dropdown">
                    <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="#">{{Session()->get('users')['name']}}
                      <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a class="nav-link" href="#">Profile</a></li>
                      <li><a class="nav-link" href="{{'ulogout'}}">Logout</a></li>
                    </ul>
                  </li>
                  @else
                  <li class="nav-item">
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{'home'}}">
                  ...
                  <p>MS-<strong>Shop</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
